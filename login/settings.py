...
SECRET_KEY = 'django-insecure-6w-nkm%us@-pr=h^2=q@&0=wc#4+4jb&5q0046p!*23$qsdv)='
...
# Django's default session settings (check if these are not modified)
